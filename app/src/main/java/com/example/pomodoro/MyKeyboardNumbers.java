...
public class MyKeyboardNumbers extends LinearLayout implements View.OnClickListener {
   ...
   public MyKeyboardNumbers(Context context){
       this(context,null,0);
   }

    public MyKeyboardNumbers(Context context, AttributeSet attrs){
        this(context,attrs,0);
    }

    public MyKeyboardNumbers(Context context, AttributeSet attrs, int defStyleAttr){
